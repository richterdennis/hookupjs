...
export function registerLoaders(loaders) {
	...
	function load(url, context, nextLoad) {
		let type = context.importAttributes?.type || 'javascript';

		if (context.format === 'module-typescript') type = 'typescript';
	...
	function resolve(specifier, context, nextResolve) {
		if (
			...
			context.parentURL && (
				...
				&& !context.parentURL.endsWith('/node_modules/hookupjs/lib/boot.js')
			)
...
export function resolveImportMap(specifier, importMap) {
